...
export default {
  ...
  methods: {
    ...
    back() {
		let pagesRoute = getCurrentPages()
		console.log(pagesRoute)
		let pageLength = pagesRoute.length
		console.log(pageLength)
		if(pageLength>2){
			let prePage = pagesRoute[pageLength-2].route;
			console.log(prePage)
			if(prePage.indexOf('login')==-1&&prePage.indexOf('register')==-1){
				window.history.go(-1);
				console.log("------1")
			}else {
				window.history.go(-2);
